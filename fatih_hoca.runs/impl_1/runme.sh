...
HD_PWD='C:/Users/anil_/FPGAProjects/fatih_hoca/fatih_hoca.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log streamadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source streamadder.tcl -notrace
