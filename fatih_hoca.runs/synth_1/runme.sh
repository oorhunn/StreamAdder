...
HD_PWD='C:/Users/anil_/FPGAProjects/fatih_hoca/fatih_hoca.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log streamadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source streamadder.tcl
